...
Diy_all() {
DIY_GET_COMMON_SH
git clone -b $REPO_BRANCH --single-branch https://github.com/281677160/openwrt-package package/mcydia
...
Diy_lede() {
DIY_GET_COMMON_SH
rm -rf package/lean/{luci-app-netdata,luci-theme-edge,luci-theme-opentomcat,k3screenctrl}
