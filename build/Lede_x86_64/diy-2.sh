...
sed -i 's/luci-theme-bootstrap/luci-theme-opentomcat/g' feeds/luci/collections/luci/Makefile     # 强制选择opentomcat为默认主题选项
sed -i "/uci commit luci/i\uci set luci.main.mediaurlbase=/luci-static/opentomcat" $ZZZ          # 选择opentomcat为默认主题
